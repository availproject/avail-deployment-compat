...
binary_version="$1"
binary_url="https://github.com/availproject/avail-light/releases/download/$binary_version/avail-light-linux-amd64.tar.gz"
...
if [ $? -eq 0 ]; then
    ...
    mv target/release/avail-light-fat-linux-amd64 target/release/avail-light-fat
else
    echo "Building from source!"
    cargo build -p avail-light-fat --release
fi
